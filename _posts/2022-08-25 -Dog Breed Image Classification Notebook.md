...
# ModelCheckpoint callback - save best weights
checkpoint_2 = ModelCheckpoint(filepath='vgg16model.weights.best.hdf5',
                                  save_best_only=True,
                                  verbose=1)
# Use an early stopping callback to stop training
# once we no longer have improvements in our validation loss
...
history_vgg16 = model_vgg16.fit(train_generator,
                              validation_data=validation_generator,
                              epochs=30,
                              callbacks=[early_stop,checkpoint_2,plot_loss_1],verbose=1)
```
...
![png](output_69_0.png)
    ...
    accuracy
    	training         	 (min:    0.014, max:    0.061, cur:    0.061)
    	validation       	 (min:    0.021, max:    0.074, cur:    0.074)
    Loss
    	training         	 (min:    4.284, max:    4.771, cur:    4.284)
    	validation       	 (min:    4.177, max:    4.710, cur:    4.177)
    385/385 [==============================] - 8144s 21s/step - loss: 4.2836 - accuracy: 0.0608 - val_loss: 4.1767 - val_accuracy: 0.0738
    Epoch 5/30
     54/385 [===>..........................] - ETA: 1:21:01 - loss: 4.1842 - accuracy: 0.0770
    ...
    ----> 1 history_vgg16 = model_vgg16.fit(train_generator,
          2                               validation_data=validation_generator,
          3                               epochs=30,
          4                               callbacks=[early_stop,checkpoint_2,plot_loss_1],verbose=1)
    

    File ~\anaconda3\envs\deeplearning\lib\site-packages\keras\utils\traceback_utils.py:64, in filter_traceback.<locals>.error_handler(*args, **kwargs)
         62 filtered_tb = None
         63 try:
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\keras\engine\training.py:1409, in Model.fit(self, x, y, batch_size, epochs, verbose, callbacks, validation_split, validation_data, shuffle, class_weight, sample_weight, initial_epoch, steps_per_epoch, validation_steps, validation_batch_size, validation_freq, max_queue_size, workers, use_multiprocessing)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\util\traceback_utils.py:150, in filter_traceback.<locals>.error_handler(*args, **kwargs)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\def_function.py:915, in Function.__call__(self, *args, **kwds)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\def_function.py:947, in Function._call(self, *args, **kwds)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\function.py:2453, in Function.__call__(self, *args, **kwargs)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\function.py:1860, in ConcreteFunction._call_flat(self, args, captured_inputs, cancellation_manager)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\function.py:497, in _EagerDefinedFunction.call(self, ctx, args, cancellation_manager)
    ...
    File ~\anaconda3\envs\deeplearning\lib\site-packages\tensorflow\python\eager\execute.py:54, in quick_execute(op_name, num_outputs, inputs, attrs, ctx, name)
         52 try:
...
The VGG16 model did not perform well, and it was very slow. After 48 hours of the model running, I only got to 4 epochs and a validation score of 6%. I decided to stop the model and move to the next one. 
